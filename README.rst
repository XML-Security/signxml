...
* Support for exclusive XML canonicalization with inclusive prefixes (``InclusiveNamespaces`` with ``PrefixList``, required to verify signatures generated by some SAML implementations)
